...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Vendas</b>ABC</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <a href="#" onclick="alert('Entre em contato com administrador do sistema');">Esqueci minha senha</a><br>
